...
import { D3DonutChart, D3LineChart, ChartStyle } from '@canopy/charts';
...
export default function DonutChartPage() {
  ...
  const step3Code = `// Create a simple donut chart
const data = [
  { date: '2024-01', value: 10 },
  { date: '2024-02', value: 45 },
  { date: '2024-03', value: 30 },
...
/>`;
  ...
  const tags = [t('tags.proportion'), t('tags.composition'), t('tags.percentage')];
  ...
  const implementationCode = `// components/charts/DonutChart.tsx
...
export default function DonutChart({ data, width = 600, height = 400 }) {
  ...
  const usageCode = `// Interactive Donut Chart
<D3DonutChart
  data={sampleData}
  datasets={['A', 'B', 'C']}
